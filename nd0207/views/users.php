                ...
                $resultReq = $app->userList($dbc);
                    if($resultReq) {
                        ...
                        foreach($resultReq as $key => $val) {    
                            ...
                            <td>'.$val['role'].'</td>';
                        echo '<td>
                                  <a href="#exampleModal" class="btn btn-primary me-2" data-bs-toggle="modal" data-id="'.$val['idusr'].'" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>';
                                  if($roleid != 2) {
                                    echo '<a type="button" class="btn btn-danger me-2" title="Delete" href="./actions/deleteuserAction.php?ID='.$val['idusr'].'" onclick="return confirm(\'Are you sure you want to delete this user?\');"><i class="fa fa-trash" aria-hidden="true"></i></a>';
                                  }
                               echo '</td>
                             </tr>';
                        }

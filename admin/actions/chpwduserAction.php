...
if (!empty($_POST["csrf_token"])) {
    if (hash_equals($_SESSION['csrf_token'], $_POST['csrf_token'])) {
           ...
           if($rexec==1) {
           $_SESSION['msg'] = '<div class="alert alert-success" role="alert"><strong>Well done! </strong>User password has been reset!</div>';
           } else {
           $_SESSION['msg'] = '<div class="alert alert-danger alert-mg-b" role="alert"><strong>Error: </strong>User password has been not reset!</div>'; 
           }
